...
import { getCardEntrance, getScaleEmphasis } from '../../sdk/microDelights';
...
const renderMainContent = (content, style, frame, startFrame, fps, animations) => {
  ...
  // Calculate emphasis animation if enabled
  let emphasisScale = 1;
  if (animConfig.emphasis?.enabled) {
    ...
    if (frame >= emphasisStart && frame < emphasisStart + emphasisDuration) {
