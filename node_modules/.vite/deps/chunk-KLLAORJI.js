...
var delayRenderInternal = (scope, environment, label2, options) => {
  ...
  if (environment.isRendering) {
    const timeoutToUse = (options?.timeoutInMilliseconds ?? (typeof scope === "undefined" ? defaultTimeout : scope.remotion_puppeteerTimeout ?? defaultTimeout)) - 2e3;
...
var delayRender = (label2, options) => {
  return delayRenderInternal(typeof window !== "undefined" ? window : void 0, getRemotionEnvironment(), label2, options);
};
...
var continueRender = (handle) => {
  continueRenderInternal(typeof window !== "undefined" ? window : void 0, handle, getRemotionEnvironment());
};
var DelayRenderContextType = (0, import_react17.createContext)(null);
var useDelayRender = () => {
  const environment = useRemotionEnvironment();
  const scope = (0, import_react17.useContext)(DelayRenderContextType);
  const delayRender2 = (0, import_react17.useCallback)((label2, options) => {
    return delayRenderInternal(scope ?? (typeof window !== "undefined" ? window : void 0), environment, label2, options);
  }, [environment, scope]);
  const continueRender2 = (0, import_react17.useCallback)((handle) => {
    continueRenderInternal(scope ?? (typeof window !== "undefined" ? window : void 0), handle, environment);
  }, [environment, scope]);
...
var CanUseRemotionHooks = (0, import_react19.createContext)(false);
...
var useVideoConfig = () => {
  ...
  const context = (0, import_react18.useContext)(CanUseRemotionHooks);
...
var useCurrentFrame = () => {
  const canUseRemotionHooks = (0, import_react22.useContext)(CanUseRemotionHooks);
  const env = useRemotionEnvironment();
  ...
  const context = (0, import_react22.useContext)(SequenceContext);
...
var Freeze = ({
  ...
  const timelineContext = (0, import_react21.useContext)(TimelineContext);
...
var CanvasRefForwardingFunction = ({ width, height, fit, className, style }, ref) => {
  ...
  const draw = (0, import_react24.useCallback)((imageData) => {
...
var Canvas = import_react24.default.forwardRef(CanvasRefForwardingFunction);
var CACHE_SIZE = 5;
var getActualTime = ({
  loopBehavior,
  durationFound,
...
var AnimatedImage = (0, import_react23.forwardRef)(({
  src,
  width,
  height,
  onError,
  ...
  const mountState = (0, import_react23.useRef)({ isMounted: true });
  ...
  const [imageDecoder, setImageDecoder] = (0, import_react23.useState)(null);
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const [decodeHandle] = (0, import_react23.useState)(() => delayRender2(`Rendering <AnimatedImage/> with src="${resolvedSrc}"`));
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();
  const currentTime = frame / playbackRate / fps;
  const currentTimeRef = (0, import_react23.useRef)(currentTime);
  currentTimeRef.current = currentTime;
  const ref = (0, import_react23.useRef)(null);
  (0, import_react23.useImperativeHandle)(canvasRef, () => {
  ...
  const [initialLoopBehavior] = (0, import_react23.useState)(() => loopBehavior);
  (0, import_react23.useEffect)(() => {
    const controller = new AbortController();
    decodeImage({
      resolvedSrc,
...
var RenderAssetManager = (0, import_react26.createContext)({
  registerRenderAsset: () => {
    return;
  },
...
var RenderAssetManagerProvider = ({ children }) => {
  const [renderAssets, setRenderAssets] = (0, import_react26.useState)([]);
  const registerRenderAsset = (0, import_react26.useCallback)((renderAsset) => {
    validateRenderAsset(renderAsset);
    setRenderAssets((assets) => {
      return [...assets, renderAsset];
    });
  }, []);
  const unregisterRenderAsset = (0, import_react26.useCallback)((id) => {
...
var Artifact = ({ filename, content, downloadBehavior }) => {
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react25.useContext)(RenderAssetManager);
  const env = useRemotionEnvironment();
  const frame = useCurrentFrame();
  const [id] = (0, import_react25.useState)(() => {
...
var LoopContext = (0, import_react28.createContext)(null);
var useLoop = () => {
  return import_react28.default.useContext(LoopContext);
};
var Loop = ({ durationInFrames, times = Infinity, children, name, ...props }) => {
  ...
  const loopDisplay = (0, import_react28.useMemo)(() => {
    return {
  ...
  const loopContext = (0, import_react28.useMemo)(() => {
    return {
...
var PreloadContext = (0, import_react30.createContext)({});
var preloads = {};
var updaters = [];
...
var PrefetchProvider = ({ children }) => {
  const [_preloads, _setPreloads] = (0, import_react30.useState)(() => preloads);
...
var usePreload = (src) => {
  const preloads2 = (0, import_react29.useContext)(PreloadContext);
...
var DurationsContext = (0, import_react31.createContext)({
  durations: {},
  setDurations: () => {
...
var DurationsContextProvider = ({ children }) => {
  const [durations, setDurations] = (0, import_react31.useReducer)(durationReducer, {});
...
var LogLevelContext = (0, import_react33.createContext)({
  logLevel: "info",
  mountTime: 0
});
var useLogLevel = () => {
...
var SharedAudioContextProvider = ({ children, numberOfAudioTags, audioLatencyHint }) => {
  ...
  const compositionManager = (0, import_react35.useContext)(CompositionManager);
  const component = compositionManager.compositions.find((c2) => compositionManager.canvasContent?.type === "composition" ? c2.id === compositionManager.canvasContent.compositionId : null);
  ...
  const resetAudio = (0, import_react35.useCallback)(() => {
...
var AudioForDevelopmentForwardRefFunction = (props, ref) => {
  const [initialShouldPreMountAudioElements] = (0, import_react32.useState)(props.shouldPreMountAudioTags);
  ...
  const { hidden } = (0, import_react32.useContext)(SequenceVisibilityToggleContext);
  if (!src) {
    throw new TypeError("No 'src' was passed to <Html5Audio>.");
  }
  const preloadedSrc = usePreload(src);
  const sequenceContext = (0, import_react32.useContext)(SequenceContext);
  const [timelineId] = (0, import_react32.useState)(() => String(Math.random()));
  ...
  const propsToPass = (0, import_react32.useMemo)(() => {
    return {
  ...
  const id = (0, import_react32.useMemo)(() => `audio-${random(src ?? "")}-${sequenceContext?.relativeFrom}-${sequenceContext?.cumulatedFrom}-${sequenceContext?.durationInFrames}-muted:${props.muted}-loop:${props.loop}`, [
    src,
  ...
  const context = (0, import_react32.useContext)(SharedAudioContext);
  if (!context) {
  ...
  const currentOnDurationCallback = (0, import_react32.useRef)(onDuration);
...
var AudioForPreview = (0, import_react32.forwardRef)(AudioForDevelopmentForwardRefFunction);
...
var AudioRefForwardingFunction = (props, ref) => {
  const audioContext = (0, import_react27.useContext)(SharedAudioContext);
  const {
    startFrom,
    endAt,
    trimBefore,
  ...
  const { fps } = useVideoConfig();
  const environment = useRemotionEnvironment();
  const { durations, setDurations } = (0, import_react27.useContext)(DurationsContext);
  if (typeof props.src !== "string") {
    throw new TypeError(`The \`<Html5Audio>\` tag requires a string for \`src\`, but got ${JSON.stringify(props.src)} instead.`);
  }
  const preloadedSrc = usePreload(props.src);
  const onError = (0, import_react27.useCallback)((e) => {
  ...
  const onDuration = (0, import_react27.useCallback)((src, durationInSeconds) => {
...
var Html5Audio = (0, import_react27.forwardRef)(AudioRefForwardingFunction);
...
var MediaEnabledContext = (0, import_react59.createContext)(null);
var useVideoEnabled = () => {
  const context = (0, import_react59.useContext)(MediaEnabledContext);
  if (!context) {
...
var MediaEnabledProvider = ({
  ...
  const value = (0, import_react59.useMemo)(() => ({ videoEnabled, audioEnabled }), [videoEnabled, audioEnabled]);
...
var RemotionRoot = ({
  ...
  const [fastRefreshes, setFastRefreshes] = (0, import_react58.useState)(0);
  const [manualRefreshes, setManualRefreshes] = (0, import_react58.useState)(0);
  const nonceContext = (0, import_react58.useMemo)(() => {
    let counter = 0;
    return {
      getNonce: () => counter++,
      fastRefreshes,
  ...
  const setNonceContext = (0, import_react58.useMemo)(() => {
    return {
      increaseManualRefreshes: () => {
  ...
  const logging = (0, import_react58.useMemo)(() => {
            ...
            children: (0, import_jsx_runtime29.jsx)(EditorPropsProvider, {
              children: (0, import_jsx_runtime29.jsx)(PrefetchProvider, {
                children: (0, import_jsx_runtime29.jsx)(SequenceManagerProvider, {
                  children: (0, import_jsx_runtime29.jsx)(RenderAssetManagerProvider, {
                    children: (0, import_jsx_runtime29.jsx)(ResolveCompositionConfig, {
...
var CurrentScaleContext = import_react60.default.createContext(null);
var PreviewSizeContext = (0, import_react60.createContext)({
  setSize: () => {
    return;
  },
...
var useCurrentScale = (options) => {
  const hasContext = import_react60.default.useContext(CurrentScaleContext);
  const zoomContext = import_react60.default.useContext(PreviewSizeContext);
...
var OffthreadVideoForRendering = ({
  ...
  const id = (0, import_react62.useMemo)(() => `offthreadvideo-${random(src)}-${sequenceContext?.cumulatedFrom}-${sequenceContext?.relativeFrom}-${sequenceContext?.durationInFrames}`, [
    src,
    sequenceContext?.cumulatedFrom,
    sequenceContext?.relativeFrom,
    sequenceContext?.durationInFrames
...
var VideoForDevelopmentRefForwardingFunction = (props2, ref) => {
  const context = (0, import_react63.useContext)(SharedAudioContext);
  if (!context) {
    throw new Error("SharedAudioContext not found");
  }
  const videoRef = (0, import_react63.useRef)(null);
  const sharedSource = (0, import_react63.useMemo)(() => {
  ...
  const parentSequence = (0, import_react63.useContext)(SequenceContext);
  const { hidden } = (0, import_react63.useContext)(SequenceVisibilityToggleContext);
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  const [timelineId] = (0, import_react63.useState)(() => String(Math.random()));
  const isSequenceHidden = hidden[timelineId] ?? false;
  ...
  (0, import_react63.useState)(() => playbackLogging({
    logLevel,
  ...
  const currentOnDurationCallback = (0, import_react63.useRef)(onDuration);
  currentOnDurationCallback.current = onDuration;
  ...
  const actualStyle = (0, import_react63.useMemo)(() => {
    return {
      ...style,
...
var VideoForPreview = (0, import_react63.forwardRef)(VideoForDevelopmentRefForwardingFunction);
...
function useRemotionContexts() {
  const compositionManagerCtx = import_react65.default.useContext(CompositionManager);
  const timelineContext = import_react65.default.useContext(TimelineContext);
  const setTimelineContext = import_react65.default.useContext(SetTimelineContext);
  const sequenceContext = import_react65.default.useContext(SequenceContext);
  const nonceContext = import_react65.default.useContext(NonceContext);
  const canUseRemotionHooksContext = import_react65.default.useContext(CanUseRemotionHooks);
  const preloadContext = import_react65.default.useContext(PreloadContext);
  const resolveCompositionContext = import_react65.default.useContext(ResolveCompositionContext);
  const renderAssetManagerContext = import_react65.default.useContext(RenderAssetManager);
  const sequenceManagerContext = import_react65.default.useContext(SequenceManager);
  const bufferManagerContext = import_react65.default.useContext(BufferingContextReact);
  const logLevelContext = import_react65.default.useContext(LogLevelContext);
...
var flattenChildren = (children) => {
  ...
  return childrenArray.reduce((flatChildren, child) => {
    if (child.type === import_react67.default.Fragment) {
...
var IsInsideSeriesContext = (0, import_react68.createContext)(false);
...
var useRequireToBeInsideSeries = () => {
  const isInsideSeries = import_react68.default.useContext(IsInsideSeriesContext);
  if (!isInsideSeries) {
...
var SeriesSequence = (0, import_react66.forwardRef)(SeriesSequenceRefForwardingFunction);
var Series = (props2) => {
  const childrenValue = (0, import_react66.useMemo)(() => {
    let startFrame = 0;
    const flattenedChildren = flattenChildren(props2.children);
    return import_react66.Children.map(flattenedChildren, (child, i) => {
...
var Still = (props2) => {
  ...
  return import_react69.default.createElement(Composition, newProps);
};
...
var VideoForRenderingForwardFunction = ({
  ...
  const videoConfig = useUnsafeVideoConfig();
  const videoRef = (0, import_react71.useRef)(null);
  const sequenceContext = (0, import_react71.useContext)(SequenceContext);
  const mediaStartsAt = useMediaStartsAt();
  const environment = useRemotionEnvironment();
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react71.useContext)(RenderAssetManager);
  const id = (0, import_react71.useMemo)(() => `video-${random(props2.src ?? "")}-${sequenceContext?.cumulatedFrom}-${sequenceContext?.relativeFrom}-${sequenceContext?.durationInFrames}`, [
    props2.src,
    sequenceContext?.cumulatedFrom,
    sequenceContext?.relativeFrom,
    sequenceContext?.durationInFrames
...
var VideoForRendering = (0, import_react71.forwardRef)(VideoForRenderingForwardFunction);
var VideoForwardingFunction = (props2, ref) => {
  ...
  const { fps } = useVideoConfig();
  const environment = useRemotionEnvironment();
  const { durations, setDurations } = (0, import_react70.useContext)(DurationsContext);
  ...
  const onDuration = (0, import_react70.useCallback)((src, durationInSeconds) => {
    setDurations({ type: "got-duration", durationInSeconds, src });
  }, [setDurations]);
  const onVideoFrame = (0, import_react70.useCallback)(() => {
  }, []);
...
var Html5Video = (0, import_react70.forwardRef)(VideoForwardingFunction);
...
//# sourceMappingURL=chunk-KLLAORJI.js.map
